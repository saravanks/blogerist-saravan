...
author: Alex
instagram: 'https://instagram.com/bvlktech'
twitter: 'https://twitter.com/bvlktech'
cover: /images/blog_photo.jpg
title: Blog Test Eight
---
...
const message = 'Test code block using PrismJS plugin';
func(...message);
```
